...
namespace StarForce
{
    public class Player : Character
    {
        ...
        {
            GetComponentInChildren<Animator>().SetBool(PlayerData.AnimParams.death, true);
   ...
   if (PlayerData != null)
    {
        PlayerData.OnDeath += HandleDeath;
    }
            // 确保序列化字段也被更新
        ...
        private void HandleDeath()
        {
            ...
            if (animator != null)
            {
                animator.SetBool(PlayerData.AnimParams.death, true);
            }
        }
